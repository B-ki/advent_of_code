def get_dict_input(file_path: str) -> dict:
    ...
    to :
    {
        1: [(69, 23), (27, 71), (10000000018641, 10000000010279)], 
        2: [(17, 86), (84, 37), (10000000007870, 10000000006450)]
    }
    """
    ...
    for i, line in enumerate(lines):
        if (i+1) % 4 != 0:
            ...
            if 'Prize' in line:
                str_list = line.split(',')
                value_list.append((int(str_list[0].split('=')[1]) + 10000000000000,
                                   int(str_list[1].split('=')[1]) + 10000000000000))
        else:
